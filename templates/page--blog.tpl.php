      ...
      <div class="content news container_news">
        <? if(isset($node->field_articles_image['und'][0]['filename'])) : ?>
          <div class="news_images" data-title="<?=$node->field_articles_image['und'][0]['title'];?>">
            <img src="/sites/default/files/blog/<?=$node->field_articles_image['und'][0]['filename'];?>">
          </div>
        <? endif; ?>
        <div class="news_body">
    ...
    <div class="wrapper">
      <div class="content news container_head">
        ...
        <div class="section_switch">
          <p class="switch_label active" data-switch="blog" data-type="blog" data-offset="0"><span>Блог</span></p>
          <p class="switch_label" data-switch="articles" data-type="articles" data-offset="0"><span>Статьи</span></p>
        </div>
      </div>
    </div>
  </section>
  <section class="sect main_news">
    <div class="wrapper">
      <div class="content news container_news">
          ...
          <? foreach($page['#views_contextual_links_info']['views_ui']['view']->result as $result) : ?>
            <? if($i == 0) : ?>
              <div class="container_news__block_top cb_news__width_all cb_news__photo-text">
                <div class="news_block">
                  <div class="news_block_images" onclick="location = '../blog/<?=$result->nid;?>';">
            ...
            <? elseif($i == 1) : ?>
              <div class="container_news__block_left cb_news__width_40 cb_news__no-photo">
                <div class="news_block">
                  <h3 class="news_block__title" onclick="location = '../blog/<?=$result->nid;?>';"><?=$result->node_title;?></h3>
                  <div class="news_block_text">
                    <p><?=$result->field_body[0]['raw']['safe_summary'];?></p>
                    <p class="news_block__read_more"><a href="../blog/<?=$result->nid;?>" target="_self"><?=$result->field_field_read_more[0]['rendered']['#markup'];?></a></p>
                  </div>
        ...
        <div id="read_more" class="container_news__show_more" data-type="blog" data-offset="4" data-btn-text="Что ещё новенького?"><span>Что ещё новенького?</span></div>
      </div>
    </div>
  </section>
<? endif; ?>
